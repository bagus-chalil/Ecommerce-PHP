<?php
	...
	if (isset($_POST['action']) && isset($_POST['action']) == 'order') {
	  ...
	  $stmt = $con->prepare('INSERT INTO orders ( name, email, phone,address, country, city, province, zipcode, products, grand_total) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?);');
	  $stmt->bind_param('ssssssssss',$name,$email,$phone,$address,$country,$city,$province,$zipcode,$products,$grand_total);
	  $stmt->execute();
