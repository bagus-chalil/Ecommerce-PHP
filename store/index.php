	...
	<nav class="colorlib-nav" role="navigation">
				   			...
				   			<div class="col-md-6 col-md-offset-3 col-md-pull-2 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner">
				   					<div class="desc">
					   					...
					   					<p class="category"><span>New Launch product,hot spesification,  &amp; More from many brands</span></p>
				   			...
				   			<div class="col-md-6 col-md-offset-3 col-md-pull-2 col-sm-12 col-xs-12 slider-text">
				   				<div class="slider-text-inner">
				   					<div class="desc">
					   					...
					   					<p class="category"><span>Laptop Acer &amp; Asus</span></p>
					   					<p><a href="#" class="btn btn-primary">Shop Now</a></p>
				   					</div>
				   				</div>
				   			</div>
		...
		<div id="colorlib-featured-product">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<a href="shop.php" class="f-product-1" style="background-image: url(images/item-101.jpg);">
							<div class="desc">
								<h2>Laptop <br>Brand <br>Recomendation</h2>
							</div>
						</a>
					</div>
					<div class="col-md-6">
						<div class="row">
							<div class="col-md-6">
								<a href="" class="f-product-2" style="background-image: url(images/item-101.jpg);;">
									<div class="desc">
										<h2>New <br>Arrival <br>Laptop</h2>
									</div>
								</a>
							</div>
							<div class="col-md-6">
			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center colorlib-heading">
						...
						<p>We love to tell our successful far far away, We have more product with a great quality and have a friendly price for every consument</p>
					</div>
				</div>
				<div class="row">
				<?php
								include "koneksi.php";
								$sql = "select * from tbl_produk order by nama ASC LIMIT 6";
		...
		<div id="colorlib-intro" class="colorlib-intro" style="background-image: url(images/cover-img-1.png);" data-stellar-background-ratio="0.5">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						...
						<div class="owl-carousel2">
							<div class="item">
								<div class="testimony text-center">
									<span class="img-user" style="background-image: url(images/user.png);"></span>
				...
				<div class="row">
					<div class="col-md-4">
						<article class="article-entry">
							<a href="blog.php" class="blog-img" style="background-image: url(images/user.png);"></a>
							<div class="desc">
